...
function updateQuantumTabs() {
	...
	getEl("quarkEnergyMult").textContent = "(" + (tmp.qe.div != 1 && shiftDown ? shorten(tmp.qe.mult) + "x, " + (tmp.qe.div < 1 ? shorten(1 / tmp.qe.div) + "x" : "/" + shorten(tmp.qe.div)) : shorten(tmp.qe.mult / tmp.qe.div) + "x") + ")"
