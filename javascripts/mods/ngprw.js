...
function unlockNextNGPLayer() {
	...
	getEl("welcomeMessage").innerHTML = "Congratulations, you reached the end of reset #" + (metaSave.ngPlusLayer - 1) + " mode for the first time! You have unlocked reset #" + metaSave.ngPlusLayer + " mode of NG+ Reworked! You can either hard reset the game or create a new save to start this mode."
