...
function updateInChallenges() {
	...
	if (QCs.inAny()) array.push("Quantum Challenge " + wordizeList(QCs_save.in, false, " + ", false) + (QCs_save.mod ? " (" + QCs.modData[QCs_save.mod].name + " modifier)": "") + (PCs.in() ? " (PC" + PCs_save.in + ")" : ""))
