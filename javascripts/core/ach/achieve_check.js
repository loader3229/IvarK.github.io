...
function preHiggsNGp3AchieveCheck() {
	...
	if (usedQuarks.r.min(usedQuarks.g).min(usedQuarks.b).gt(0) && colorCharge.normal.charge == 0) giveAchievement("Hadronization")
	...
	if (PCs_save.lvl >= 5) giveAchievement("Twice in a row")
