...
function setR16Tooltip() {
	...
	intergal.setAttribute('ach-tooltip', "Get " + getFullExpansion(tmp.exMode ? 3e7 : 17e6) + " Eighth Dimensions without Replicated Galaxies. Reward: Meta Accelerator raises the MA effect to an exponent.")
