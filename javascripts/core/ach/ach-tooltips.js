...
function setR16Tooltip() {
	...
	intergal.setAttribute('ach-tooltip', "Get " + getFullExpansion(1/0) + " Eighth Dimensions without Replicated Galaxies. Reward: First " + getFullExpansion(50) + " sacrificed galaxies don't get nullified.")
