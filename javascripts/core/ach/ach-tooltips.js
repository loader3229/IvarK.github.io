...
function setR16Tooltip() {
	...
	morals.setAttribute('ach-tooltip', "Reach " + shortenCosts(1e86) + " TT in any Quantum Challenge. Reward: You can buy Mastery Studies from a row above the latest bought row.")
