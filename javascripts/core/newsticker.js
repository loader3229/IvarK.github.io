...
["A brave man tried NG- and NG-- modes at the same time, but he will be dead before he would complete this mode.", 'tmp.mod.newGameMinusVersion && inNGM(2)', "am1"],
...
["Did you just do 4 modes at once? Impossible!", 'tmp.mod.newGameMinusVersion && inNGM(2) && tmp.mod.newGamePlusVersion && player.meta', "am6"],
...
["Start playing NG+3 instead. You are not doing your progress.", "tmp.mod.ngp4V", "am128"],
["If NGUd+ is a combination of NG+3 and NGUd, then why isn't NGUd' a combination of NG' and NGUd?", "tmp.mod.ngudpV", "am129"],
...
["We the friendly Duplicants, declare independence on the Pretus colony.", "tmp.qu.nanofield.apgWoke", "am221"],
["Duplicants decay Replicantis for quantum energy. That means we can decay anything for quantum energy?", "masteryStudies.has('d10')", "am229"],
