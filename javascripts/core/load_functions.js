...
function updateNGModeMessage(){
	...
	if (inNGM(2)) {
		if (aarMod.newGame4MinusRespeccedVersion) ngModeMessages.push('Welcome to NG-4R v3, the respecced version of NG-4! This mode is easier compared to NG-4, made by loader3229. Current Endgame is: 3 Infinity Challenges completed')
